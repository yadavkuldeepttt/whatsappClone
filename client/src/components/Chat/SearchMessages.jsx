        ...
        <div className="flex h-full flex-col justify-center">
          ...
          <div className="flex flex-col w-full h-full ">
            {searchedMessages.map((message) => (
              <div className="flex cursor-pointer flex-col justify-center hover:bg-background-default-hover w-full px-5 border-b-[0.4px] border-conversation-border py-5 ">
