...
function ChatLIstItem({ data, isContactsPage = false, isContactChat = true }) {
  const [{ userInfo, currentChatUser, userContacts }, dispatch] =
    useStateProvider();
    ...
    <div>
      <div
        ...
        <div className="min-h-full flex flex-col justify-center mt-3 pr-2 w-full ">
          ...
          <div className="flex border-b border-conversation-border  pb-1 pt-2 pe-2">
            <div className="flex justify-between w-full">
              ...
              {data.totalUnreadMessages > 0 && <span className="bg-icon-green px-[5px] text-sm text-end rounded-full">
